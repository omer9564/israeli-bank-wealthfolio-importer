...
issues, pull requests, discussions, and any other forum this project uses —
...
reported to the maintainer, @omer9564, via a GitHub issue or by contacting
them directly through GitHub. All complaints will be reviewed and
investigated promptly and fairly, and the reporter's privacy and security will
be respected.
...
1. **Correction** — A private, written warning for use of inappropriate
   language or other unprofessional behavior, with clarity around the nature
   of the violation.
